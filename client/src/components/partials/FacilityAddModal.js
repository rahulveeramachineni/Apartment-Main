...
import { Modal } from "bootstrap"; // Import Bootstrap 5 modal API
import $ from 'jquery';
...
class FacilityAddModal extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (
      ...
      // Use Bootstrap 5's Modal API instead of jQuery modal
          ...
          <div className="modal-dialog modal-lg">
            <div className="modal-content">
              ...
              <div className="modal-footer">
                ...
                <button form="add-facility" type="submit" className="btn btn-primary">
                  Add Facility
                </button>
              </div>
            </div>
